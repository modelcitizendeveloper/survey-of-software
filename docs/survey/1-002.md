...
sidebar_label: "1.002 Fuzzy Search"
...
**Cross-reference with 1.032 (String Similarity Metrics):**
- **1.002 (this document)**: Application-level **search engines** with fuzzy matching built-in (Whoosh, Tantivy, Pyserini)
- **1.032**: Foundational **algorithms and libraries** for calculating string similarity (Levenshtein, Jaro-Winkler, cosine)

**Conceptual difference:** This research (1.002) covers platforms that have already integrated similarity metrics into search functionality. Research 1.032 covers the building blocks - the metrics and libraries these search engines use internally. Use 1.002 when you need full-text search with fuzzy matching; use 1.032 when you need fine-grained control over similarity calculations.
