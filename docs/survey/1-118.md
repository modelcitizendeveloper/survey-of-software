...
sidebar_label: "1.118 Testing Libraries"
...
```text
<!-- Button.mdx -->
// Storybook imports removed for compatibility
// import { Canvas, Meta, Story } from '@storybook/blocks'
// import * as ButtonStories from './Button.stories'

// Storybook components removed for compatibility
...
// Storybook Canvas component removed for compatibility
