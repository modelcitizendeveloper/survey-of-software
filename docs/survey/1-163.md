---
id: 1-163
title: "1.163 Character Encoding (CJK)"
sidebar_label: "1.163 Character Encoding (CJK)"
description: "Big5, GB2312, GBK, GB18030, and Unicode CJK encoding systems. Essential for handling legacy text, cross-platform compatibility, and understanding character set "
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# 1.163 Character Encoding (CJK)

Big5, GB2312, GBK, GB18030, and Unicode CJK encoding systems. Essential for handling legacy text, cross-platform compatibility, and understanding character set evolution across Taiwan, Hong Kong, and Mainland China.
