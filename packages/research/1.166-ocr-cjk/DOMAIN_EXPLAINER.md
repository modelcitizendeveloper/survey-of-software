...
**Break-even**: If processing <100K pages/year, commercial APIs often cheaper than managing infrastructure.
...
**When commercial makes sense**: Variable volume, <100K pages/month, need 99%+ accuracy, no ML team.

**When open source makes sense**: >500K pages/month, predictable volume, have ML expertise, data sensitivity.
