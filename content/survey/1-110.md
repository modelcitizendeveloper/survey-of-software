...
| **Vue** | Teams wanting gentler onboarding than React without Angular's ceremony | 35/50 in S1 — second on adoption and first on getting started. A reasonable middle that wins no axis outright. | 3.5.42 · 2026-08-27 |
...
| **Next.js (meta-framework)** | Roughly 80% of React projects | S2 treats the meta-framework as a first-class subject because it decides routing, rendering, build tooling and deployment — most of what a team touches. It is also a SECOND lock-in, separable from the React one. | 16.3.3 · 2026-08-27 |
