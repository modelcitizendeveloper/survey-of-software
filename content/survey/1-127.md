...
|---|---|---|
| **tier_1_universal** |  | [{'name': 'pandas', 'downloads_per_month': '80M', 'github_stars': '43,000', 'survival_10yr': '99.9%', 'learning_hours': 5, 'use_case': 'Universal data foundation, time series, DataFrames', 'governance': 'NumFOCUS Sponsored'}, {'name': 'scipy (scipy.stats module)', 'downloads_per_month': '100M (scipy total)', 'github_stars': '13,000', 'survival_10yr': '99.9%', 'learning_hours': 5, 'use_case': 'Statistical distributions, Monte Carlo sampling', 'governance': 'NumFOCUS Sponsored'}] |
| **tier_2_business_finance** |  | [{'name': 'numpy-financial', 'downloads_per_month': '500K', 'github_stars': '~300', 'survival_10yr': '95%', 'learning_hours': 2, 'use_case': 'Excel formulas (NPV, IRR, PMT, FV, PV)', 'governance': 'Community (NumPy heritage)'}, {'name': 'Prophet', 'downloads_per_month': '2M', 'github_stars': '18,000', 'survival_10yr': '70%', 'learning_hours': 10, 'use_case': 'Time series forecasting (revenue, seasonality)', 'governance': 'Meta (maintenance mode)'}] |
| **tier_3_quant_finance** |  | [{'name': 'QuantLib', 'downloads_per_month': '150K', 'github_stars': '5,000', 'survival_10yr': '95%', 'learning_hours': 100, 'use_case': 'Derivatives pricing, fixed income, risk management', 'governance': 'QuantLib Foundation'}, {'name': 'vectorbt', 'downloads_per_month': '50K', 'github_stars': '4,000', 'survival_10yr': '60%', 'learning_hours': 20, 'use_case': 'Trading strategy backtesting, portfolio optimization', 'governance': 'Single maintainer (Oleg Polakow)'}] |
| **tier_4_statistical** |  | [{'name': 'statsmodels', 'downloads_per_month': '20M', 'github_stars': '10,000', 'survival_10yr': '90%', 'learning_hours': 10, 'use_case': 'Econometrics, regression, ARIMA, VAR', 'governance': 'NumFOCUS Affiliated'}, {'name': 'PyMC', 'downloads_per_month': '800K', 'github_stars': '8,000', 'survival_10yr': '85%', 'learning_hours': 40, 'use_case': 'Bayesian inference, MCMC, uncertainty quantification', 'governance': 'NumFOCUS Sponsored'}] |
...
- **market structure** — 
- **library profiles** — 
- **saas vs diy decision** — 
- **tco 3yr analysis** — 
- **ten year survival probability** — 
