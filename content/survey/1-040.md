...
> [!TIP]
> **Try it: [you want this sorted how?](/workshop/sorted-how/)** — a working demo of this survey's findings.
...
<div class="sos-tiles"><div class="sos-tile"><div class="sos-tile-h">SortedList vs bisect.insort at 1M keys</div><div class="sos-tile-n">40&times;</div><div class="sos-tile-s"><strong>SortedList</strong> 1.4 s &middot; bisect.insort 56 s</div></div><div class="sos-tile"><div class="sos-tile-h">pyrsistent 1000 updates of 100K vector</div><div class="sos-tile-n">64&times;</div><div class="sos-tile-s"><strong>pvector.set</strong> 6 ms &middot; copy a tuple each time 381 ms</div></div></div>

<figure class="sos-fig"><figcaption>insert 100K keys one at a time keeping order <span>lower is faster</span></figcaption><svg viewBox="0 0 720 192" role="img" width="100%" height="192" aria-label="insert 100K keys one at a time keeping order, compared"><title>heapq (min only): 6 ms</title><text x="158" y="17.68" class="sos-bl" text-anchor="end">heapq (min only)</text><rect x="168" y="0" width="5.3" height="26" rx="4" class="sos-bar"/><text x="181.3" y="17.68" class="sos-bv">6 ms</text><title>dict (no order): 10 ms</title><text x="158" y="49.68" class="sos-bl" text-anchor="end">dict (no order)</text><rect x="168" y="32" width="8.8" height="26" rx="4" class="sos-bar"/><text x="184.8" y="49.68" class="sos-bv">10 ms</text><title>append then sort: 24 ms</title><text x="158" y="81.68" class="sos-bl" text-anchor="end">append then sort</text><rect x="168" y="64" width="21.1" height="26" rx="4" class="sos-bar"/><text x="197.1" y="81.68" class="sos-bv">24 ms</text><title>SortedList (pure Py): 61 ms</title><text x="158" y="113.68" class="sos-bl" text-anchor="end">SortedList (pure Py)</text><rect x="168" y="96" width="53.6" height="26" rx="4" class="sos-bar"/><text x="229.6" y="113.68" class="sos-bv">61 ms</text><title>bintrees RBTree: 506 ms</title><text x="158" y="145.68" class="sos-bl" text-anchor="end">bintrees RBTree</text><rect x="168" y="128" width="444.7" height="26" rx="4" class="sos-bar"/><text x="620.7" y="145.68" class="sos-bv">506 ms</text><title>bisect.insort (C): 553 ms</title><text x="158" y="177.68" class="sos-bl" text-anchor="end">bisect.insort (C)</text><rect x="168" y="160" width="486.0" height="26" rx="4" class="sos-bar"/><text x="662.0" y="177.68" class="sos-bv">553 ms</text></svg></figure>
...
[/workshop/sorted-how/](/workshop/sorted-how/).
...
- **Run the race on your machine.** [/workshop/sorted-how/](/workshop/sorted-how/) — pick a size, start
...
*Rewritten 2026-08-19 after every figure was measured for the sorted-how floor model
(`/workshop/sorted-how/`). Download counts are pypistats.org, last 30 days, read 2026-08-19.
...
again in the browser at [/workshop/sorted-how/](/workshop/sorted-how/) (Pyodide 314.0.5, Python
