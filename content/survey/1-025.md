...
| **SymPy** | General purpose, teaching | Baseline (1x) |
| **primefac** | Automatic algorithm selection | 2x vs SymPy |
| **gmpy2** | High-performance primality | 40x vs SymPy (100-digit) |
| **cypari2** | Research, 50-100 digits | 50x vs SymPy |
