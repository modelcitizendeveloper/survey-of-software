...
keywords: ["chise", "cjkvi", "ids", "unihan"]
...
| Library | Download | Parse Index |
|---|---|---|
| **Unihan** | 5 min | 2 min |
| **CHISE** | 15 min | 30 min |
| **IDS** | 0 min¹ | 1 min |
| **CJKVI (basic)** | 0 min² | 1 min |
| **CJKVI (full IVD)** | 5 min | 10 min |


**What the research found**

- **These are layers, not alternatives — the recommendation is to use all four** — Unihan as the foundation of properties and readings, CHISE for semantics and etymology, IDS for structure and component search, CJKVI for locale-aware variant normalization.
- **Three of the four are standards-backed and one is not** — Unihan, IDS and CJKVI score 9.4-9.9/10 on risk with 90-95% five-year confidence. CHISE sits at 5.25/10 and 65% — the survey calls it risky but mitigatable.
- **Component search and handwriting recognition need IDS specifically** — Ideographic Description Sequences describe how a character is built from parts. No amount of Unihan property data answers 'which characters contain this component'.
- **Variant normalization is locale-dependent and that is CJKVI's whole job** — The same abstract character is written differently across Chinese, Japanese and Korean locales. Skipping this layer means silently treating those as different characters.
- **Ten-year confidence drops sharply even for the safe entries** — Unihan falls from 95% at five years to 75% at ten, CHISE from 65% to 45%. Acquisition cost is one-time; keeping the data current is not.
...
- Performance: `<100`ms candidate generation ✅
