...
|---|---|---|
| **Recharts** | React declarative JSX, D3-based, SVG rendering | Standard React dashboards, declarative charts |
| **D3.js** | Low-level toolkit, rendering-agnostic (SVG/Canvas/WebGL) | Maximum control, custom visualizations, framework-agnostic |
| **ECharts** | Canvas/SVG/WebGL rendering, Apache Foundation | Large datasets, 3D charts, geographic maps, enterprise |
| **Chart.js** | Canvas rendering, imperative config API | Simple charts, framework-agnostic, quick setup |
| **visx** | React + D3 bridge, SVG rendering, Airbnb-backed | Custom visualizations with D3 power + React patterns |
| **Nivo** | React declarative, D3-based, SVG with SSR support | Server-side rendering, Next.js/Gatsby, beautiful defaults |
| **Victory** | React declarative, cross-platform (web + React Native) | React Native apps, cross-platform consistency |
