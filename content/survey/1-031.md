...
| Library | Group | Status |
|---|---|---|
| **difflib** | line based | active |
| **diff-match-patch** | line based | active |
| **libdiff** | line based | Not identifiable as a maintained project — the closest match (kristapsdz/libdiff, C, 15 stars) has not been touched since 2018-06-11. Treat as unavailable. |
| **tree-sitter** | semantic | active |
| **gumtree** | semantic | active |
| **difftastic** | semantic | active |
| **jsondiff** | specialized | active |
| **xmldiff** | specialized | active |
