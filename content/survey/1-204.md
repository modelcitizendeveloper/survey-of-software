...
| **LangChain** | Multi-step orchestration around the retrieval, not the retrieval itself | General-purpose LLM orchestration. Its RecursiveCharacterTextSplitter is the baseline this survey recommends starting from, but the framework's strength is workflow rather than ingestion. v1.3.17 (2026-08-25). | 1.3.17 · 2026-08-25 |
| **Haystack** | Pipeline-shaped RAG with explicit components | The third option the S1 pass profiles. v3.1.0 (2026-08-25) — actively released alongside the other two. | 3.1.0 · 2026-08-26 |
