---
title: "1.176 TMX File Format Libraries"
description: "Python libraries for TMX, the XML standard for exchanging translation memory between CAT tools: translate-toolkit, hypomnema and polib compared."
keywords: ["tmx", "translation memory exchange", "translate-toolkit", "hypomnema", "polib", "cat tools", "localization", "xliff", "translation memory", "tmx 1.4b", "level 2 inline markup", "gettext"]
...
|---|---|---|
| **translate-toolkit** | Default choice — battle-tested in enterprise localization, 20+ formats, CLI tools. Trade-off: GPL-2.0+ may restrict commercial use. | 3.19.19 · 2026-09-01 |
| **hypomnema** | Modern alternative — full TMX 1.4b Level 2 (nested inline markup), type-safe, streaming for large files, MIT licensed. Trade-off: pre-1.0, breaking changes possible. | 0.8 · 2026-04-09 |
| **polib** | gettext library with TMX conversion support; reach for it when gettext is the center of gravity. | 1.2.0 · 2023-02-23 |
...
- translate-toolkit is the production default, and its GPL-2.0+ license is the decision that actually constrains commercial users
...
- The license, not the feature matrix, is the fork in this category
