...
- Maintenance Health
- Vendor Durability (longevity, funding model, licence history)
...
> longevity, funding MODEL, licence history and adoption breadth — signals about
...
- **Funding model**: venture-backed. Worth knowing as a *risk shape* rather than
  as a score: VC-backed vendors are the ones for whom a licence change or an
...
- **Business model**: open-source core plus a managed service. The dual
  structure is what puts advanced features behind the Enterprise licence —
...
- **Funding model**: venture-backed — and this is the entry that shows why the
  ...
  licence changed under existing users.
...
- **Funding model**: venture-backed, enterprise sales motion. The same
  licence-change risk applies as for any VC-backed vendor here.
