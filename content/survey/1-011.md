...
|---|---|---|---|
| **neo4j (official driver)** | Most new Neo4j projects — the default | Tier 1. The official driver, v6.2.0 (2026-05-04), and the best async story in the category; the others need a separate package for it. | 6.2.0 · 2026-05-04 |
...
| **python-arango** | ArangoDB deployments | Tier 1, official. Note the license change recorded in S4 — ArangoDB moved to BSL 1.1 at 3.12+, which reached existing users. | 8.3.4 · 2026-08-25 |
