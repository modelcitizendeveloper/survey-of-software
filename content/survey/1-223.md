...
|---|---|---|
| **radicale** | CalDAV server with custom storage backend | GPL-3.0 |
| **xandikos** | Lightweight CalDAV server (Git-backed only) | GPL-3.0 |
| **wsgidav** | WebDAV server (no CalDAV, but extensible WSGI base) | MIT |
| **icalendar** | iCalendar parsing (needed for any CalDAV server) | — |
| **vobject** | iCalendar/vCard parsing; used by Radicale internally. Revived under the py-vobject org in 2024 after six dormant years | — |
