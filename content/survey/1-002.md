...
description: "Python fuzzy string matching: RapidFuzz, TheFuzz, python-Levenshtein, Jellyfish and difflib — throughput, licence, and when phonetics beat edit distance."
...
Python fuzzy string matching: RapidFuzz, TheFuzz, python-Levenshtein, Jellyfish and difflib — throughput, licence, and when phonetics beat edit distance.
...
- The licence is the real fork: FuzzyWuzzy's GPL-2.0 is what pushes commercial users off the incumbent, not its speed
