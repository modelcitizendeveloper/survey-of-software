...
> - Companions also bumped: **icalendar 7.1.2** (Python 3.10–3.14), **tsdav 2.2.1**. **vobject was revived** under the py-vobject org (v0.9.9, Dec 2024) — it is no longer abandoned.
...
**Version**: 7.1.2 (May 2026; Python 3.10–3.14) — *was 6.3.2 at original survey*
...
> - **`caldav` is now v3.2.1** (May 2026), **Python ≥3.10**, with **full async (AsyncDAVClient) since v3.0** — "synchronous only" is no longer true. **`icalendar` is 7.1.2** (Py 3.10–3.14).
...
> versions: caldav 3.2.1 (async), icalendar 7.1.2, vobject revived (py-vobject 0.9.9).
...
> **🔄 2026 Correction (verified 2026-05-31):** Current icalendar is **7.1.2** (Py 3.10–3.14). The
...
> (async since v3.0, Py ≥3.10); **icalendar** 7.1.2. **Google CalDAV is read/write** (not read-only;
