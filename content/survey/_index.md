...
**[What is this? →](/about)** | **[The Vision →](/vision)** | **[Collections →](/collections)** | **[Methodology →](/survey/replication)**
...
- ✅ [**1.026** Combinatorics](/survey/1-026) - itertools, more-itertools, SymPy
- **1.027** Numerical Integration - Quadrature methods
- ✅ [**1.028** FFT Libraries](/survey/1-028) - FFTW, pyFFTW, scipy.fft
- ✅ [**1.029** Matrix Decomposition](/survey/1-029) - NumPy, SciPy, LAPACK wrappers
...
- ✅ [**1.081** Convex Hull](/survey/1-081) - scipy, CGAL, Qhull, discreture
- ✅ [**1.082** Voronoi & Delaunay](/survey/1-082) - scipy.spatial, triangle, PyVista
- ✅ [**1.083** Point Cloud Processing](/survey/1-083) - Open3D, PCL, PDAL
- ✅ [**1.084** Mesh Processing](/survey/1-084) - Trimesh, PyMeshLab, libigl
- ✅ [**1.085** Collision Detection](/survey/1-085) - Shapely, FCL, Bullet Physics
...
**Total Defined**: 199 research slots
**Completed**: 111 pieces (56%)
**Remaining**: 88 pieces
...
> **New series**: Domain-Specific Data & Analysis ([1.3xx vision →](/survey/taxonomy-1.3xx-vision))

- **1.300** Public Finance Modeling - OpenFisca, PolicyEngine, Tax-Calculator
- **1.301** Government Data Access - Census, USAspending, legislative data APIs
- **1.302** Budget Document Parsing - CAFR/ACFR extraction, financial statements
- **1.303** Civic Entity Resolution - Agency normalization, jurisdiction matching
- ✅ [**1.304** Procurement & Contracts](/survey/1-304) - Contract network analysis, bid pattern detection, grant relationship mapping
- **1.305** Fiscal Health Metrics - Municipal credit, pension modeling, debt sustainability
- **1.306-1.309** _Available for future civic tech categories_
