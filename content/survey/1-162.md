...
keywords: ["azure computer vision", "google cloud vision", "tegaki", "zinnia"]
...
| Library | Primary Strength | Primary Weakness | Latest release |
|---|---|---|---|
| **Zinnia** | Speed, efficiency, proven in IME | Japanese-focused, training inflexible | 1.1.18 · 2019-03-01 |
| **Azure Computer Vision** | Enterprise compliance, hybrid | Higher cost, Microsoft ecosystem bias | — |
| **Google Cloud Vision** | Best accuracy, zero maintenance | Cost at scale, internet required | 3.15.0 · 2026-06-22 |
| **Tegaki** | Flexibility, Python-friendly | Slower than Zinnia, less active development | 0.22.1 · 2026-07-12 |
...
- **The choice is self-hosted against cloud, and the survey's scores barely separate them** — Zinnia 9.0, the two cloud APIs 8.5, Tegaki 7.5. All four are production-ready, so the decision is made by deployment constraints rather than by capability.
- **Zinnia is Japanese-focused, and that is a scoping fact rather than a weakness to work around** — Fifteen-plus years in production IME systems, fastest in the survey — with training inflexibility and a Japanese orientation as the named limits.
- **Cloud accuracy comes with an internet dependency and a bill that scales** — Google Cloud Vision is rated best accuracy with zero maintenance; its listed weaknesses are cost at scale and requiring connectivity. Neither applies to Zinnia.
- **Ten-year confidence is where these separate, not five-year** — Five-year confidence spans 75-90%; at ten years it falls to 55-70%, with Tegaki lowest. Handwriting recognition is being absorbed into general vision models.
- **Azure's differentiator is compliance and hybrid deployment, not accuracy** — It matches Google on rapid score with enterprise compliance and hybrid options as its stated strength — which is what makes it the answer for regulated work.
