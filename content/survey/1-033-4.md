...
| Library | Best for |
|---|---|
| **HanLP** | Chinese-focused, best accuracy |
| **LTP** | Fast Chinese, CPU deployment |
| **Stanza** | Multi-language unified API |
| **spaCy zh_core** | Production pipelines, ecosystem |
| **Google Cloud API** | Rapid deployment, managed |
