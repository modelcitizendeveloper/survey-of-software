...
description: "Named Entity Recognition libraries and frameworks optimized for Chinese, Japanese, and Korean text"
keywords: ["languages", "accuracy", "speed latency", "deployment", "model size", "HanLP", "LTP", "Stanza", "spaCy zh_core", "Google Cloud API", "Amazon Comprehend", "Azure Text Analytics"]
...
|---|---|---|
| **HanLP** | Chinese-focused, best accuracy | 2.1.3 · 2025-10-19 |
| **LTP** | Fast Chinese, CPU deployment | 4.2.14 · 2024-06-08 |
| **Stanza** | Multi-language unified API | 1.14.0 · 2026-07-15 |
| **spaCy zh_core** | Production pipelines, ecosystem | 3.8.16 · 2026-08-24 |
| **Google Cloud API** | Rapid deployment, managed | 8.0.0 · 2026-09-07 |
| **Amazon Comprehend** | AWS integration, custom entities | — |
| **Azure Text Analytics** | Microsoft ecosystem, enterprise | — |
...
**Date**: 2026-01-29
**Phase owner**: Survey of Software research crew
