...
| Library | Group | Paradigm | Verdict |
|---|---|---|---|
| **Tailwind CSS** | primary | Utility-first | 5-year sustainability: 8.5/10 |
| **Bootstrap** | primary | Component-based | 5-year sustainability: 9/10 |
| **CSS Modules** | primary | Scoped CSS | 5-year sustainability: Not assessed |
| **Material-UI** | primary | React component library | 5-year sustainability: 8/10 |
| **Emotion** | primary | CSS-in-JS | 5-year sustainability: 3/10 (declining) |
| **Styled-Components** | primary | CSS-in-JS | 5-year sustainability: 3/10 (maintenance mode) |
| **Bulma** | secondary | Flexbox-based semantic | 5-year sustainability: High risk (single maintainer) |
| **PicoCSS** | secondary | Classless semantic | 5-year sustainability: High risk (abandonment concerns) |
| **Open Props** | secondary | CSS variables / design tokens | 5-year sustainability: Not assessed |
