...
| Algorithm | Licence | Cost |
|-----------|---------|------|
| **SM-2** | Public domain since 1988 | Nothing |
| **FSRS** | MIT | Nothing |
| **SM-18** | Proprietary | No published terms, and no third-party implementation to licence |
...
maintain, what the licence permits, what the review history already contains, and
...
quotes, and are labelled as such.
...
- **Professional certification** — fixed exam date, so scheduling is optimised
...
### For open-source projects
→ **FSRS**. The only modern option whose licence permits it.
...
**Confidence Level**: High for algorithm behaviour and licensing; the medical-education
...
**Development Budget**:
- **Neither SM-2 nor FSRS costs anything to licence.** The budget question
