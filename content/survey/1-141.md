...
| **fsrs-rs-python** | Deployments where the pure-Python install size is the constraint | Python bindings over the Rust implementation, 6MB installed. Same algorithm and same parameters as py-fsrs; choose on packaging, not on behavior. | 0.9.2 · 2026-06-09 |
