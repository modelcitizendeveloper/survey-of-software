...
- **bintrees is deprecated and unmaintained since 2014** — Migrate to SortedContainers for production code; use only for education
...
For C extension performance: bintrees (though unmaintained since 2013).
