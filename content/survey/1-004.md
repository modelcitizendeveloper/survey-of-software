...
|---|---|---|
| **SortedContainers** | B+ tree-like (list of sorted lists) | General-purpose sorted collections |
| **bintrees** | AVL, Red-Black, Splay trees | Educational purposes only |
| **BTrees** | B-trees (multi-way) | Persistent storage, MVCC, integer keys |
