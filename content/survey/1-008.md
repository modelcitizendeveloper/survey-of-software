...
|---|---|---|
| **tslearn** | DTW + Shapelets + ML | documented |
| **STUMPY** | Matrix Profile for pattern discovery | documented |
| **sktime** | Unified ML framework | documented |
| **tsfresh** | Automatic feature extraction | documented |
| **dtaidistance** | Fast DTW distances | documented |
| **pyts** | Imaging + Transformations | documented |
