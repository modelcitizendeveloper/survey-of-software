...
| Library | Random Read | Best Use |
|---|---|---|
| **SQLite (WAL)** | Good | OLTP, SQL |
| **DuckDB** | Excellent (columnar) | OLAP, analytics |
| **RocksDB** | Good (with bloom) | Write-heavy KV |
| **LevelDB** | Good | Simpler KV |
| **LMDB** | Excellent | Read-heavy KV |
| **BadgerDB** | Good | Go KV, large values |
