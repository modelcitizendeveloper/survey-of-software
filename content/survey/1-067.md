...
|---|---|---|
| **websockets** | Python | Standalone async WebSocket server and client |
| **aiohttp WebSocket** | Python | WebSocket within an existing aiohttp HTTP app |
| **Starlette WebSocket** | Python | WebSocket within FastAPI/Starlette app |
| **python-socketio** | Python | Socket.IO protocol server (rooms, events, reconnect) |
| **picows** | Python | High-throughput WebSocket (Cython, 1.5-2x faster than websockets) |
| **ws** | JavaScript/Node.js | Standard Node.js WebSocket server and client |
| **socket.io** | JavaScript/Node.js | Real-time framework with rooms, events, reconnect |
| **uWebSockets.js** | JavaScript/Node.js | Ultra-high throughput WebSocket (C++ binding) |
| **reconnecting-websocket** | JavaScript/Browser | Auto-reconnecting WebSocket client |
