...
| Library | Focus | Status |
|---|---|---|
| **APScheduler** | Application-embedded time-based scheduling | documented |
| **schedule** | Minimal human-friendly periodic scheduling | documented |
| **Celery** | Distributed task queue with beat scheduling | documented |
| **Airflow** | DAG-based data/workflow orchestration | documented |
| **Prefect** | Modern Python-first workflow orchestration | documented |
| **Dagster** | Asset-centric / AI-native data orchestration | documented |
| **Temporal** | Durable execution for long-running workflows | documented |
