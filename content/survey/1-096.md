...
| **Prefect** | Modern Python-first workflow orchestration | PLATFORM. The growth-stage alternative to Airflow — lighter to operate, smaller ecosystem | 3.8.4 · 2026-08-25 |
| **Dagster** | Asset-centric / AI-native data orchestration | PLATFORM, asset-oriented rather than task-oriented. Choose it when the thing you want to reason about is the data, not the job | 1.13.19 · 2026-08-21 |
