...
|---|---|---|
| **stem** | Python | Tor circuit control, onion service creation |
| **requests + SOCKS5 via Tor** | Python | Anonymous HTTP/HTTPS through Tor daemon |
| **torpy** | Python | Pure Python Tor (no daemon required) |
| **i2plib / DIY SAM client** | Python | I2P network access via SAM bridge |
| **Nym websocket API** | Python | GPA-resistant anonymous messaging via Nym mixnet |
