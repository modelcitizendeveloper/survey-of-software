...
|---|---|---|
| **React Hook Form** | uncontrolled | Standard React projects |
| **Formik** | controlled | Legacy codebases only (migrate away) |
| **TanStack Form** | signals-based | TanStack ecosystem users |
| **Zod** | schema_validation | TypeScript projects (default choice) |
| **Yup** | schema_validation | Legacy JavaScript projects |
| **Valibot** | schema_validation | Bundle-critical applications |
