...
description: "Comprehensive analysis of form state management and schema validation libraries for React applications. Covers the separation of concerns between form…"
keywords: ["github stars", "npm weekly downloads", "bundle size", "React Hook Form", "Formik", "TanStack Form", "typescript", "Zod", "Yup", "Valibot", "react-hook-form@7.x", "formik@2.x", "zod@3.x", "yup@1.x", "valibot@0.x", "@tanstack/react-form@0.x"]
...
Comprehensive analysis of form state management and schema validation libraries
for React applications. Covers the separation of concerns between form libraries
(React Hook Form, Formik, TanStack Form) and validation libraries (Zod, Yup,
Valibot), with practical recommendations based on bundle size, TypeScript support,
and ecosystem fit.
...
|---|---|---|---|
| **React Hook Form** | uncontrolled | Standard React projects | 7.87.0 · 2026-08-30 |
| **Formik** | controlled | Legacy codebases only (migrate away) | 2.4.9 · 2025-11-10 |
| **TanStack Form** | signals-based | TanStack ecosystem users | 1.33.5 · 2026-08-21 |
| **Zod** | schema_validation | TypeScript projects (default choice) | 4.5.4 · 2026-08-29 |
| **Yup** | schema_validation | Legacy JavaScript projects | 1.7.1 · 2025-09-21 |
| **Valibot** | schema_validation | Bundle-critical applications | 1.4.2 · 2026-06-28 |
...
- **Form state and validation are separate concerns with distinct libraries** — Choose one form library + one validation library, connected via resolvers
- **React Hook Form dominates with 5M weekly downloads and 12KB bundle** — Default choice for form state management in 2026
- **Formik is slow-moving, not abandoned — last release 2.4.9 (2025-11-10), 839 open issues** — Avoid for new projects, migrate existing codebases to React Hook Form
- **Zod dominates validation with 12M weekly downloads** — Default validation library for TypeScript projects
- **Valibot offers 95%+ bundle size reduction vs Zod (1-2KB vs 45KB)** — Critical for mobile/PWA where bundle size matters


**What the research recommends**

**Default** — React Hook Form + Zod - Standard choice for 90% of React projects

| Use case | Pick |
|---|---|
| standard react | React Hook Form + Zod |
| bundle critical | React Hook Form + Valibot (75% smaller) |
| tanstack ecosystem | TanStack Form + Zod |
| legacy javascript | React Hook Form + Yup |
| existing formik | Plan migration to React Hook Form |

**Combinations**

| Combo | Size | Recommendation |
|---|---|---|
| React Hook Form + Valibot | 14KB | Bundle-critical applications |
| React Hook Form + Zod | 57KB | Default for most projects |
| TanStack Form + Zod | 55KB | TanStack ecosystem users |
| React Hook Form + Yup | 72KB | Legacy JavaScript projects |
| Formik + Yup | 104KB | Avoid - migrate away |
...
3. **Maintenance**: Slow — 839 open issues, releases in bursts (last: 2.4.9, 2025-11-10)
...
- Last commit: 2025-11-10 (React 19 compatibility fix)
...
Formik is **abandoned**:
- Last commit: 2025-11-10 (a React 19 compatibility fix); last release 2.4.9, same day
- No security patches
- No bug fixes
...
- All personas: Formik is slow-moving (last release 2025-11-10; 839 open issues) — prefer an actively developed alternative
...
| **Formik** | 12/60 ⚠️ | See note | ⚠️ PLAN A MIGRATION - slow-moving, 839 open issues |

> ⚠️ **Formik's 12/60 predates a correction and has not been recomputed.**
> That score was derived largely from "abandoned since December 2021, no
> commits for 3+ years", which is false: verified 2026-08-25, Formik released
> 2.4.6 (2024-04-24), 2.4.8 and 2.4.9 (2025-11-10), and its repository was last
> pushed 2025-11-10 with a React 19 compatibility fix. The maintenance inputs to
> this score are wrong and the score would rise if recomputed — by how much
> depends on the rubric weights, which is why no new number is asserted here. `>`
> What survives the correction: 839 open issues and releases arriving in long
> bursts mean a bug you hit may wait a long time. That is a real reason to
> prefer React Hook Form or TanStack Form for new work. It is not a reason to
> treat Formik as dead, and "MIGRATE NOW" overstated it.
...
**Summary:** **SLOW-MOVING**, not abandoned. Releases arrive in bursts — 2.4.6 (April 2024), then 2.4.8 and 2.4.9 (November 2025), the last of them a React 19 compatibility fix. 34K stars, 2M downloads/week, and 839 open issues. The risk is responsiveness, not death: a bug you hit may wait a long time.

**Status:** Case study in library abandonment.

**Critical Issues:**
- Releases in bursts; last commit 2025-11-10 (a React 19 fix), 839 open issues
...
Formik was the dominant React form library (2017-2021) and is now **slow-moving rather than abandoned** — a distinction this survey previously got wrong. Verified 2026-08-25: releases 2.4.6 (2024-04-24), 2.4.8 and 2.4.9 (2025-11-10); the repository was last pushed 2025-11-10 with a commit reading `fix: jsx ref for react 19`; it is not archived. What is true is that 839 issues are open and releases arrive in long bursts, so a bug you hit may wait. 34K stars and 2M downloads/week are largely legacy projects.
...
- Last release: v2.4.9 (2025-11-10)
...
**API maturity: Stable, and moving slowly**

**Version history:**
- Current version: v2.4.9 (2025-11-10)
- Preceded by v2.4.8 (2025-11-07) and v2.4.6 (2024-04-24)
- Breaking changes: none across the 2.4.x line
- Deprecation policy: none published

**Production readiness:**
- Established through 2019-2021 (React 16, 17) and still shipping
- React 19 support landed in the 2025-11-10 release, so the "degrading
  compatibility" story this survey used to tell is out of date
...
|--------|--------|-----------------|---------------|
| Last commit | 2025-11-10 | days | days |
| Releases/year | ~2, in bursts | 24 | 18 |
| Open issues | 839 | ~150 | ~40 |
