...
| **esbuild** | Go-based bundler, extreme compilation speed | Library builds, CI/CD optimization, speed-critical projects |
| **Rollup** | ES module-native bundler, library-focused | JavaScript libraries, multiple output formats (ESM/CJS/UMD) |
| **Parcel** | Zero-config bundler, convention over configuration | Rapid prototyping, learning, hackathons |
