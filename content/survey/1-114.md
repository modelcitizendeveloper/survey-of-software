...
|---|---|---|---|
| **Vite** | Native ESM dev server; UNIFIED Rolldown (Rust) bundler as of Vite 8 (was esbuild-dev/Rollup-prod) | Modern web apps (SPA/MPA), React/Vue/Svelte projects; also the engine under Slidev (1.110.6), Vitest, Storybook | 8.2.2 · 2026-08-20 |
...
| **Rollup** | ES module-native bundler, library-focused | JavaScript libraries, multiple output formats (ESM/CJS/UMD) | 4.63.0 · 2026-08-25 |
...
| **Rolldown** | Rust bundler, drop-in Rollup replacement; now the unified bundler inside Vite 8 | Vite 8 apps (default); Rollup migrations wanting Rust speed | 1.2.6 · 2026-08-26 |
| **Webpack** | JavaScript bundler; loader + plugin architecture, maximum configurability | Existing large codebases and edge cases needing the mature plugin ecosystem; not greenfield projects | 5.109.2 · 2026-07-28 |
