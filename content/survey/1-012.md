...
|---|---|---|
| **Leiden (leidenalg)** | C++ core + Python bindings | production-standard |
| **Louvain (NetworkX)** | Pure Python | prototype-only |
| **Louvain (python-louvain)** | Pure Python | legacy |
| **Infomap** | C++ core + Python bindings | directed-networks |
| **Label Propagation (NetworkX)** | Pure Python | quick-exploration |
| **Label Propagation (NetworKit)** | C++ core + Python bindings | extreme-scale |
| **Spectral Clustering (scikit-learn)** | C/Cython | small-graphs-known-k |
| **CDlib** | Python (meta-library) | research-benchmarking |
