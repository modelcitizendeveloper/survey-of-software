...
description: "Community Detection Libraries: Louvain, Leiden, Infomap, Label Propagation, Spectral Clustering, CDlib"
keywords: ["stars", "performance", "connectivity guarantee", "Leiden", "Louvain", "flow based", "Infomap", "Label Propagation", "deterministic", "Spectral Clustering", "algorithm count", "CDlib"]
...
Community Detection Libraries: Louvain, Leiden, Infomap, Label Propagation, Spectral Clustering, CDlib
...
|---|---|---|---|
| **Leiden (leidenalg)** | C++ core + Python bindings | production-standard | 0.12.0 · 2026-05-24 |
| **Louvain (NetworkX)** | Pure Python | prototype-only | 0.8.2 · 2024-03-18 |
| **Louvain (python-louvain)** | Pure Python | legacy | 0.16 · 2022-01-29 |
| **Infomap** | C++ core + Python bindings | directed-networks | 2.15.1 · 2026-08-04 |
| **Label Propagation (NetworkX)** | Pure Python | quick-exploration | 3.6.1 · 2025-12-08 |
| **Label Propagation (NetworKit)** | C++ core + Python bindings | extreme-scale | 11.2.1 · 2026-01-09 |
| **Spectral Clustering (scikit-learn)** | C/Cython | small-graphs-known-k | 1.9.0 · 2026-06-02 |
| **CDlib** | Python (meta-library) | research-benchmarking | 0.4.1 · 2026-07-25 |
...
- Leiden is production standard - fixes Louvain's disconnected communities defect
- Leiden is faster than Louvain despite extra refinement phase (20x on 39M nodes)
- Louvain suitable for prototyping only - migrate to Leiden before production
- Infomap excels on directed/weighted/temporal/multiplex networks via information theory
- Label Propagation (NetworKit) is only algorithm that scales to >10M nodes
