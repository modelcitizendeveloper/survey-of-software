...
|---|---|---|
| **jieba** | HMM-based Chinese word segmentation | Foundational text segmentation for simplification pipeline |
| **OpenCC** | Dictionary-based Traditional/Simplified conversion | Normalizing text variants before simplification |
| **HanLP** | Multi-task NLP platform (segmentation, POS, NER, parsing) | Advanced linguistic analysis for sophisticated simplification |
| **MCTS (Dataset)** | 691K parallel sentence pairs (complex ↔ simple Chinese) | Fine-tuning transformer models for text simplification |
