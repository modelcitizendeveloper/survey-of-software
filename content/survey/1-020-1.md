---
title: "1.020.1 Linear Programming Libraries"
description: "Survey of Python linear programming libraries for optimization problems. Covers scipy.optimize.linprog (lightweight), PuLP (modeling-focused), CVXPY (convex…"
keywords: ["linear programming", "optimization", "scipy", "PuLP", "CVXPY", "OR-Tools", "constraint solving", "resource allocation"]
...
| Library | Strengths | Latest release |
|---|---|---|
| **scipy.optimize.linprog** | No dependencies, simple API, good for small problems | 1.18.1 · 2026-08-21 |
| **PuLP** | Readable problem definition, free solvers (CBC), commercial solver integration | 3.3.2 · 2026-06-19 |
| **CVXPY** | Expressive syntax, handles MIP/QP/SDP, academic backing | 1.9.2 · 2026-06-22 |
| **OR-Tools** | Production-ready, excellent performance, constraint programming support | 9.15.6755 · 2026-01-14 |
...
- Start with scipy for simple problems (<1000 variables)
- Use PuLP for readable problem modeling with flexibility
- Choose CVXPY when problem extends beyond LP (QP, SDP)
- Pick OR-Tools for production systems requiring performance
- All libraries support the same problem class (LP), differ in API and performance
...
| When | Pick |
|---|---|
| quick start | scipy.optimize.linprog for prototyping |
| production | OR-Tools or PuLP with commercial solver |
| research | CVXPY for flexibility across problem types |
| education | PuLP for readable problem formulation |
