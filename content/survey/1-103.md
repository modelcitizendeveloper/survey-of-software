...
description: "Python libraries for parsing and rendering Markdown content. mistune (13M/month) for fast parsing with plugins. markdown (10M/month) for Python-Markdown with…"
keywords: ["mistune", "markdown", "commonmark"]
...
Python libraries for parsing and rendering Markdown content. mistune (13M/month) for fast parsing with plugins. markdown (10M/month) for Python-Markdown with extensions. commonmark (2M/month) for strict CommonMark spec compliance.
...
|---|---|---|
| **mistune** | Fast Markdown parsing with plugins | 3.3.4 · 2026-07-22 |
| **markdown** | Extensible Markdown with 40+ extensions | 3.10.3 · 2026-07-30 |
| **commonmark** | Nothing new - the repository is marked DEPRECATED and directs users to markdown-it-py | 0.9.2 · 2026-05-28 |
| **markdown-it-py** | Strict CommonMark spec compliance - the maintained 100% CommonMark implementation for Python (Executable Books) | 4.2.0 · 2026-05-07 |
...
- mistune v3 offers fastest parsing with plugin architecture
- markdown (Python-Markdown) most extensible with 40+ extensions
- markdown-it-py is the maintained 100% CommonMark implementation for Python (Executable Books) - use it for spec compliance
- commonmark (commonmark-py) is deprecated - last release 0.9.1 in 2019, and its own repository directs users to markdown-it-py
- mistune v3 is async-ready for modern frameworks
...
> **🔄 Baseline verification (2026-07, verified 2026-07-13):** First freshness check on this survey. Current versions — **mistune 3.3.3** (released 2026-07-09; still the speed champion), **Python-Markdown** (still the extension champion, 40+ extensions), and **markdown-it-py** (the actively-maintained 100% CommonMark implementation, Executable Books). **Correction to the ranking below:** the **`commonmark` (commonmark-py)** package listed as the "spec-compliance champion" is **deprecated** — last release 0.9.1 in **2019**, and its own repository is marked DEPRECATED with maintainers directing users to **markdown-it-py**. Read every "use commonmark for spec compliance" recommendation in this file as **"use markdown-it-py"**; the deep S1 `commonmark-libraries.md` already documents the unmaintained status. (For JS callers — minor coverage here — the current set is marked 12.x, markdown-it 14.x, remark 15.x / unified 11.x.)
