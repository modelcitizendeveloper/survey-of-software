...
| Library | Use For |
|---|---|
| **mistune** | Fast Markdown parsing with plugins |
| **markdown** | Extensible Markdown with 40+ extensions |
| **commonmark** | Nothing new - the repository is marked DEPRECATED and directs users to markdown-it-py |
| **markdown-it-py** | Strict CommonMark spec compliance - the maintained 100% CommonMark implementation for Python (Executable Books) |
