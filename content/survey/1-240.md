---
title: "1.240 Container Networking & Service Mesh"
description: "Container networking and service mesh compared: Cilium, Calico, Flannel, Istio, Linkerd, Envoy and Consul Connect — eBPF versus iptables, mesh versus none."
keywords: ["platform", "github stars", "cncf status", "Cilium", "Kubernetes", "Calico", "Kubernetes / bare metal", "Istio", "note", "Linkerd", "Envoy Proxy", "Cross-platform", "Flannel", "Consul Connect", "Kubernetes + VMs", "Weave Net"]
aliases: ["/survey/1-121/"]
...
# 1.240 Container Networking & Service Mesh

Container networking and service mesh compared: Cilium, Calico, Flannel, Istio, Linkerd, Envoy and Consul Connect — eBPF versus iptables, mesh versus none.
...
|---|---|---|
| **Cilium** | Go | Apache 2.0 |
| **Calico** | Go | Apache 2.0 |
| **Istio** | Go | Apache 2.0 |
| **Linkerd** | Go / Rust | Apache 2.0 |
| **Envoy Proxy** | C++ | Apache 2.0 |
...
- **Modes**:
  ...
  - **Ambient mode**: **GA in Istio 1.24 (November 2024)** — No sidecars; ztunnel (Rust) node agent + optional
...
GA since Istio 1.24 (November 2024).
...
- **Important**: Since February 2024, stable releases are published only by Buoyant Enterprise
  for Linkerd (BEL); the open source channel provides edge releases only
