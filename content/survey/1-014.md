...
|---|---|---|
| **NetworkX** | Prototyping, research, <100K nodes | BSD (permissive) |
| **igraph** | R users, mid-scale (100K-1M nodes) | GPL-2.0 |
| **OR-Tools** | Production logistics, optimization | Apache 2.0 |
