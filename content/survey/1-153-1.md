...
|---|---|---|
| **Stanza** | PyTorch-based, neural transformer models | Production systems requiring UD standards, multilingual support |
| **HanLP** | PyTorch/TensorFlow, multi-task learning | Chinese-focused projects, semantic parsing, research innovation |
| **LTP** | PyTorch-based, Chinese-optimized | Chinese-only projects with HIT standards preference |
| **Stanford CoreNLP** | Java-based, pre-neural models | Legacy system maintenance only |
