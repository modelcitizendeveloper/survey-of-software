...
|---|---|---|---|
| **pyannote.audio** | open source | open-source | General-purpose diarization, best accuracy |
| **pyannote Community-1** | open source | open-source | Latest state-of-the-art open-source diarization |
| **NVIDIA NeMo (Sortformer)** | open source | open-source | End-to-end diarization, GPU-optimized pipelines |
| **WhisperX** | open source | open-source | Combined transcription + diarization |
| **diart** | open source | open-source | Real-time streaming diarization |
| **simple-diarizer** | open source | open-source | Quick prototyping with SpeechBrain models |
| **AssemblyAI** | commercial | commercial-api | Production API, best noise robustness |
| **Deepgram** | commercial | commercial-api | Real-time streaming diarization API |
