...
description: "Comprehensive analysis of speaker diarization libraries — the task of determining \"who spoke when\" in multi-speaker audio. Covers the dominant open-source…"
keywords: ["open source", "commercial", "pyannote.audio", "pyannote Community-1", "NVIDIA NeMo", "WhisperX", "diart", "simple-diarizer", "AssemblyAI", "Deepgram", "Google Cloud STT"]
...
|---|---|---|---|---|
| **pyannote.audio** | open source | open-source | General-purpose diarization, best accuracy | 4.0.7 · 2026-06-30 |
| **pyannote Community-1** | open source | open-source | Latest state-of-the-art open-source diarization | 4.0.7 · 2026-06-30 |
| **NVIDIA NeMo (Sortformer)** | open source | open-source | End-to-end diarization, GPU-optimized pipelines | 3.0.0 · 2026-08-07 |
| **WhisperX** | open source | open-source | Combined transcription + diarization | 3.8.6 · 2026-06-26 |
| **diart** | open source | open-source | Real-time streaming diarization | 0.9.2 · 2025-02-12 |
| **simple-diarizer** | open source | open-source | Quick prototyping with SpeechBrain models | 0.0.13 · 2022-12-12 |
| **AssemblyAI** | commercial | commercial-api | Production API, best noise robustness | 1.3.0 · 2026-09-02 |
| **Deepgram** | commercial | commercial-api | Real-time streaming diarization API | 1.0.3 · 2016-03-16 |
| **Google Cloud STT** | commercial | commercial-api | Enterprise integration, language coverage | — |
...
**Default** — pyannote.audio Community-1 (best open-source accuracy, active development)

| When | Pick |
|---|---|
| production api | AssemblyAI for accuracy, Deepgram for speed |
| real time | diart for streaming, Deepgram API for managed streaming |
| research | NeMo Sortformer for custom training, pyannote for fine-tuning |
| combined stt | WhisperX for transcription + diarization in one pipeline |
...
pyannote.audio is the dominant open-source speaker diarization toolkit, providing neural building blocks for the complete diarization pipeline. Built on PyTorch, it offers pretrained models and pipelines that can be fine-tuned on custom data. Developed primarily by Herve Bredin at CNRS (French National Center for Scientific Research) and now backed by pyannoteAI (commercial entity).
...
- **Primary maintainer**: Herve Bredin, CNRS researcher (French National Center for Scientific Research)
