...
- **vs Black: architecture-dependent.** On x86_64 about 20x at 1 MB *falling* to 16x at 12 MB; on aarch64 about 20x at 1 MB *rising* to 32x at 12 MB (measured 2026-08-27, ruff 0.16.5 vs black 26.5.1; x86_64 on a DigitalOcean s5-8vcpu-16gb-30gb, aarch64 on a WSL2 laptop). Ruff's lead over Black is roughly twice as large on ARM as on x86 once the corpus is big enough to show it; faster still with caching, which the measurement disables
