...
|---|---|---|
| **NetworkX** | Pure Python | default |
| **rustworkx** | Rust core + Python bindings | performance-commercial |
| **graph-tool** | C++ core + Python bindings | academic-maximum-performance |
| **igraph** | C core + Python bindings | cross-platform-balanced |
| **scipy.csgraph** | C/Cython | scipy-stack-lightweight |
