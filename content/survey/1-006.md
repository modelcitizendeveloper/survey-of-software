...
description: "Graph Search Libraries: NetworkX, rustworkx, graph-tool, igraph, scipy.csgraph"
keywords: ["stars", "performance", "a star support", "NetworkX", "rustworkx", "graph-tool", "igraph", "downloads", "scipy.csgraph"]
...
Graph Search Libraries: NetworkX, rustworkx, graph-tool, igraph, scipy.csgraph
...
|---|---|---|---|
| **NetworkX** | Pure Python | default | 3.6.1 · 2025-12-08 |
| **rustworkx** | Rust core + Python bindings | performance-commercial | 0.18.1 · 2026-07-30 |
| **graph-tool** | C++ core + Python bindings | academic-maximum-performance | — |
| **igraph** | C core + Python bindings | cross-platform-balanced | 1.0.0 · 2025-10-23 |
| **scipy.csgraph** | C/Cython | scipy-stack-lightweight | 1.18.1 · 2026-08-21 |
...
- NetworkX is the default choice for 90% of projects - ease of use dominates
- rustworkx offers best balance of performance + permissive license (Apache-2.0)
- graph-tool is fastest but has high installation complexity and LGPL license
- igraph is best for cross-platform projects (R integration) but lacks A*
- scipy.csgraph is best for SciPy stack users but lacks A* and graph objects
...
**NetworkX handles**:
- Small: `<1`K nodes → instant
- Medium: 1K-100K nodes → seconds
- Large: `>100`K nodes → slow (use faster library)
...
✅ Small-to-medium graphs (`<100`K nodes)
...
- ❌ Slow for large networks (`>100`K nodes)
...
- ⚠️ Graphs `>100`K nodes routinely
