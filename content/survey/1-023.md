...
description: "Symbolic mathematics: SymPy, SageMath, mpmath, Maxima and Mathematica — a pure-Python CAS against full computer-algebra systems and arbitrary precision."
keywords: ["primary", "related", "SymPy", "SageMath", "mpmath", "Mathematica", "Maxima"]
...
Symbolic mathematics: SymPy, SageMath, mpmath, Maxima and Mathematica — a pure-Python CAS against full computer-algebra systems and arbitrary precision.
...
| Library | Group | Description | Latest release |
|---|---|---|---|
| **SymPy** | primary | Pure Python symbolic mathematics library | 1.14.0 · 2025-04-27 |
| **SageMath** | primary | Comprehensive mathematics software system built on Python | 10.9 · 2026-09-06 |
| **mpmath** | related | Arbitrary-precision floating-point arithmetic | 1.4.1 · 2026-08-21 |
| **Mathematica** | related | Commercial symbolic computation system | 1.0.1 · 2022-10-31 |
| **Maxima** | related | Open-source computer algebra system | — |
