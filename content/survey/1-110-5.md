...
| **Astro** | JavaScript | modern DX, multi-framework projects |
| **Next.js** | JavaScript/React | React ecosystem, hybrid SSG/SSR |
| **Docusaurus** | JavaScript/React | React-based documentation |
| **VitePress** | JavaScript/Vue | Vue-based documentation |
| **Jekyll** | Ruby | GitHub Pages, simple blogs |
| **Gatsby** | JavaScript/React | AVOID - ecosystem collapsing |
| **Eleventy** | JavaScript | templating flexibility, simplicity |
| **Starlight** | JavaScript/Astro | beautiful documentation sites |
