...
description: "Static site generators: Hugo, Astro, Next.js, Docusaurus, VitePress and Jekyll — build speed, authoring experience, and how much JavaScript reaches the reader."
keywords: ["github stars", "first release", "backing", "Hugo", "npm weekly downloads", "Astro", "Next.js", "Docusaurus", "VitePress", "Jekyll", "Gatsby", "Eleventy", "Starlight"]
...
Static site generators: Hugo, Astro, Next.js, Docusaurus, VitePress and Jekyll — build speed, authoring experience, and how much JavaScript reaches the reader.
...
|---|---|---|---|
| **Hugo** | Go | large-scale sites, speed-critical projects | — |
| **Astro** | JavaScript | modern DX, multi-framework projects | 7.3.1 · 2026-09-03 |
| **Next.js** | JavaScript/React | React ecosystem, hybrid SSG/SSR | 16.3.4 · 2026-09-05 |
| **Docusaurus** | JavaScript/React | React-based documentation | 3.10.2 · 2026-07-10 |
| **VitePress** | JavaScript/Vue | Vue-based documentation | 1.6.4 · 2026-09-04 |
| **Jekyll** | Ruby | GitHub Pages, simple blogs | — |
| **Gatsby** | JavaScript/React | AVOID - ecosystem collapsing | 5.16.1 · 2026-02-10 |
| **Eleventy** | JavaScript | templating flexibility, simplicity | 2.0.1 · 2025-11-19 |
| **Starlight** | JavaScript/Astro | beautiful documentation sites | 0.42.0 · 2026-09-02 |
...
- **performance** — Hugo is 10-100x faster than JS-based SSGs for large sites (10,000 pages in 20s vs Next.js 35+ min); Astro provides best balance: 10-30s for 1000 pages with modern DX; Docusaurus/Gatsby have memory issues (OOM) at 1000+ pages
- **developer experience** — Astro offers best modern DX with Islands Architecture and multi-framework support; Next.js provides largest React ecosystem but heavier than pure SSGs; Hugo has steeper learning curve (Go templates) but fastest builds
- **ecosystem health** — Astro is fastest growing framework with 18% adoption and 113 releases in 2025; Gatsby ecosystem is collapsing: acquired, Gatsby Cloud sunset, plugin failures; Hugo remains most mature and stable with 86K stars and frequent updates
- **use case recommendations** — blogs: Hugo (speed) or Eleventy (flexibility); documentation: Starlight (modern) or VitePress (Vue) or Hugo (scale); marketing: Astro (performance) or Next.js (React); ecommerce: Next.js with ISR (dynamic updates); large scale: Hugo only (1000+ pages without OOM); enterprise: Hugo (security, on-premise)
- **strategic risks** — migration urgency: Gatsby sites should migrate to Astro/Next.js within 6-12 months
...
| When | Pick |
|---|---|
| default 2026 | Astro (best growth, DX, performance balance) |
| maximum speed | Hugo (only choice for 1000+ pages) |
| react ecosystem | Next.js (not Gatsby) |
| vue ecosystem | VitePress |
| documentation | Starlight (beautiful defaults) |
| simplicity | Eleventy (zero-config, flexible) |
...
> **Corrected 2026-09-07.** This section previously recommended **Forestry.io**, which
> shut down on **2023-04-22**, and **NetlifyCMS**, which was renamed **Decap CMS** in 2023
> (final npm publish under the old name: 2022-04-13). Both were named as live options for
> over three years. The editing layer is a category in its own right — see
> [1.110.7 Static Site Content Editing](../../../1.110.7-static-site-content-editing/),
> which profiles the current field and carries the cautionary record these names belong to.

| SSG | Why | CMS Options | Hosting Cost | Setup Time |
|-----|-----|-------------|--------------|------------|
| **Hugo** ⭐ | Fast builds, templates, cheap hosting | Decap, Sveltia, CloudCannon | $0-5/mo | `<4` hours |
| **Astro** | Modern DX, CMS integrations, templates | Keystatic, Decap, Sveltia, 20+ others | $0-10/mo | `<1` day |
| **Eleventy** | Simple, flexible, easy handoff | Decap, Sveltia | $0-5/mo | `<4` hours |
| **Jekyll** | GitHub Pages free hosting, familiar | Decap | $0 (GitHub Pages) | `<4` hours |

### Best Choice: Hugo + Decap or Sveltia
...
- **CMS:** Decap (the mature default) or Sveltia (a maintained rewrite of it). **Budget for
  the OAuth broker** — every client-side git-based CMS needs one to exchange a Git host
  token, and it is the most common deployment failure in that category. 1.110.7 covers it.
...
3. Configure Decap (or Sveltia) + an OAuth broker
...
- CMS integration (Decap, Sveltia, Keystatic — see 1.110.7; Forestry shut down 2023, NetlifyCMS is now Decap)
