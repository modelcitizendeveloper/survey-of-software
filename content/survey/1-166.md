...
| **PaddleOCR** | Deep learning (detection + recognition pipeline) | Chinese-primary, highest accuracy, production systems |
| **EasyOCR** | PyTorch deep learning (detection + recognition) | Multi-language, scene text, PyTorch projects |
