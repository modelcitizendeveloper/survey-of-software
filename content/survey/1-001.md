...
| **NumPy** | Quicksort + radix sort (stable) | Numerical arrays, integers (O(n) radix) |
| **SortedContainers** | B-tree variant | Incremental updates (182x speedup) |
| **Pandas** | Timsort wrapper | DataFrame sorting (being replaced by Polars) |
| **Polars** | Rust parallel sort | Large DataFrames (11.7x faster than Pandas) |
