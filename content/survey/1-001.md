...
| **NumPy** | Quicksort + radix sort (stable) | Numerical arrays, integers (O(n) radix) | 2.5.2 · 2026-08-09 |
...
| **Polars** | Rust parallel sort | Large DataFrames (11.7x faster than Pandas) | 1.44.1 · 2026-08-26 |
