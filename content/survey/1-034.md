...
| **django-anymail** | The anti-lock-in choice — one interface across 15+ providers, so switching ESP is a config change. The default for Django apps using a managed provider. | 15.1 · 2026-07-30 |
