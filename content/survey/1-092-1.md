...
|---|---|---|---|
| **librosa** | analysis | open-source | Audio/music analysis and feature extraction |
| **essentia** | analysis | open-source | High-performance MIR with C++ backend |
| **madmom** | analysis | open-source | Beat tracking and music-specific MIR |
| **pydub** | manipulation | open-source | Simple audio editing and format conversion |
| **pedalboard** | manipulation | open-source | Studio-quality audio effects (Spotify) |
| **soundfile** | io | open-source | High-quality audio file I/O |
| **audioread** | io | open-source | Universal format decoding |
| **torchaudio** | ml integration | open-source | PyTorch audio ML pipelines |
