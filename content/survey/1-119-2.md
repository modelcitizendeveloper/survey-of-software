...
description: "APNs, FCM, react-native-firebase, notifee, firebase_messaging, flutter_local_notifications, Web Push/VAPID, OneSignal, Novu"
date: 2026-02-17
lastmod: 2026-02-17
weight: 1119200
---
...
Legacy library. Unmaintained as of 2023.

- **npm**: `react-native-push-notification`
- **Status**: Deprecated. No new releases; security vulnerabilities unfixed.
...
### OneSignal
Most popular cross-platform push notification service. Free tier: unlimited push to unlimited devices.
...
|---------|------|----------------|---------|--------|
| @react-native-firebase/messaging | FCM delivery, token, topics | ~370,000 | 21.x | Active (Invertase) |
| @notifee/react-native | Display, channels, actions | ~125,000 | 9.x | Active (Invertase) |
| @expo/expo-notifications | Delivery + display (Expo) | ~190,000 | 0.29.x | Active (Expo) |
| react-native-push-notification | Legacy all-in-one | ~85,000 (declining) | 8.x | **Unmaintained** |
...
| flutter_local_notifications | Display, channels, scheduling | 160/160 | ~3,400 | 18.x |
| awesome_notifications | Delivery + display (FCM-integrated) | 140/160 | ~1,500 | 0.10.x |
...
Last meaningful commit: 2022. Issues accumulating with no responses from maintainer. Multiple security vulnerabilities open. Usage is declining (~85K/week, down from ~150K peak) as developers migrate.
