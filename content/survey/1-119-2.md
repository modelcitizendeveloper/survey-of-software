...
|---|---|---|
| **@react-native-firebase/messaging** | JavaScript/TypeScript | Apache 2.0 |
| **@notifee/react-native** | JavaScript/TypeScript | Apache 2.0 |
| **firebase_messaging** | Dart | BSD |
| **flutter_local_notifications** | Dart | MIT |
| **firebase-admin** | Node.js/Python/Java/Go | Apache 2.0 |
