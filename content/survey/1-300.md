...
description: "Tax-benefit microsimulation libraries for evidence-based policy analysis. Covers income taxes, benefits, and fiscal modeling across multiple jurisdictions."
keywords: ["github", "stars", "coverage", "notable use", "OpenFisca", "PolicyEngine", "Tax-Calculator", "Cost-of-Capital-Calculator"]
...
Tax-benefit microsimulation libraries for evidence-based policy analysis. Covers income taxes, benefits, and fiscal modeling across multiple jurisdictions.
...
|---|---|---|---|
| **OpenFisca** | Python | AGPL-3.0 | 44.7.1 · 2026-09-04 |
| **PolicyEngine** | Python | AGPL-3.0 | 5.3.0 · 2026-08-30 |
| **Tax-Calculator** | Python | CC0-1.0 | 1.2.4 · 2021-08-28 |
| **Cost-of-Capital-Calculator** | Python | CC0-1.0 | 2.1.1 · 2026-04-17 |
...
- Four major open-source libraries: OpenFisca (France), PolicyEngine (US/UK), Tax-Calculator (US federal), Cost-of-Capital-Calculator (US business)
- PolicyEngine US (2024) covers all 50 states + federal, most comprehensive US tool
- Tax-Calculator is CBO gold standard for federal tax analysis, public domain
- OpenFisca pioneered 'rules as code' approach, adopted internationally
- Three major gaps: property tax (no open-source library), sales tax research (only commercial APIs), multi-jurisdictional integration
