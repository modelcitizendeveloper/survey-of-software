...
|---|---|---|
| **pyate** | Linguistic + Statistical | Technical terminology |
| **KeyBERT** | Transformer (BERT) | Semantic keywords |
| **YAKE** | Statistical | Quick extraction |
| **RAKE-NLTK** | Statistical | General keywords |
| **textacy** | spaCy extension | Broader NLP + terms |
| **topia.termextract** | Legacy POS-based | Legacy projects |
| **spaCy** | NLP infrastructure | Framework/integration |
