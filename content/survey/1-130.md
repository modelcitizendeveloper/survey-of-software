...
- **cost arbitrage** — infrastructure scaling: Self-hosted costs scale logarithmically, not linearly - 10x users ≠ 10x cost; managed comparison: EspoCRM self-hosted: $64/user over 3 years vs Salesforce: $1,500/user (23x difference); sweet spot: 5-50 users = maximum TCO advantage for self-hosted vs managed SaaS
...
## The install target is the real constraint
