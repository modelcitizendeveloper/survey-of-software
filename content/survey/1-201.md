...
**Optional Extras (pip install):**
- LLM providers: anthropic, aws, azure-ai-inference, bedrock, google-genai
...
| **Anthropic Claude** | ✅ Via extras | ✅ Supported | ✅ Supported |
| **Google Gemini** | ✅ Via extras | ✅ Supported | ✅ Supported |
...
| **Provider Count** | 75+ (via Together.AI) | Multiple providers | Limited documentation |
