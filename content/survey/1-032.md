...
|---|---|---|---|
| **rapidfuzz** | C++ (SIMD) | The production default - 400K ops/sec and 12M downloads a month. Also the drop-in replacement for fuzzywuzzy, at 10x the speed. | 3.14.5 · 2026-04-07 |
