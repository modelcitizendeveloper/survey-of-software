...
| Library | How it works | Performance |
|---|---|---|
| **rapidfuzz** | C++ (SIMD) | 400K ops/sec |
| **python-Levenshtein** | C | 120K ops/sec |
| **textdistance + C backend** | C | 100K ops/sec |
| **strsim (Rust)** | Rust | 350K ops/sec |
| **Apache Commons Text** | Java | 80K ops/sec |
| **textdistance (pure Python)** | Python | 8K ops/sec |
