...
description: "FFT Libraries: FFTW, scipy.fft, numpy.fft, pyFFTW, KissFFT"
keywords: ["performance", "github stars", "maintainer", "FFTW", "scipy.fft", "numpy.fft", "pyFFTW", "KissFFT"]
...
FFT Libraries: FFTW, scipy.fft, numpy.fft, pyFFTW, KissFFT
...
| Library | Language | Performance | Latest release |
|---|---|---|---|
| **FFTW** | C/C++/Fortran | 100% (baseline) | — |
| **scipy.fft** | Python | 90-95% (FFTW backend) | 1.18.1 · 2026-08-21 |
| **numpy.fft** | Python | 40-50% | 2.5.3 · 2026-09-06 |
| **pyFFTW** | Python (Cython wrapper) | 96-99% | 0.15.1 · 2025-10-22 |
| **KissFFT** | C | 50-60% | — |
...
- Performance matters less than you think: scipy.fft is 90% of FFTW speed, and FFT is often <10% of total runtime
- Profile before optimizing: Don't use pyFFTW unless scipy.fft is proven bottleneck
...
| cpp | FFTW |
| embedded | KissFFT |
| ml | scipy.fft (preprocessing) OR torch.fft (on-the-fly) |
