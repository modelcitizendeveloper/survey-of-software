...
|---|---|---|
| **Jieba** | Prefix dictionary + DAG + Dynamic programming + HMM | Text tokenization (de facto standard for Chinese NLP) |
| **cntext** | Word frequency, readability metrics, sentiment analysis | Batch text analysis in Python |
| **CRIE (Chinese Readability Index Explorer)** | SVM with 82 multilevel linguistic features | Research-grade accuracy, diagnostic reports |
| **CkipTagger** | POS tagging, tokenization, NER | Comprehensive NLP pipeline for Traditional Chinese |
