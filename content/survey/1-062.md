...
- OWASP names Argon2id first, but does NOT restrict bcrypt to legacy use: the Password Storage Cheat Sheet reads 'strong, slow hashing algorithms such as Argon2id, bcrypt, or PBKDF2', and separately advises 'For legacy systems using bcrypt, use a work factor of 10 or more' (read 2026-08-26)
- argon2-cffi: 74,095,778 downloads/month (pypistats, 2026-08-26), zero CVEs, OWASP-compliant defaults out of box
- bcrypt (PyCA): 215,267,956 downloads/month (pypistats, 2026-08-26), ~2.9x argon2-cffi. Not merely legacy inertia — PyCA shipped bcrypt 5.0.0 on 2025-09-25, and OWASP still lists bcrypt among its acceptable algorithms
...
| 2023 | Argon2id primary | bcrypt acceptable |
| 2026 | Argon2id named first | bcrypt still listed as acceptable; the "legacy" wording applies to tuning existing bcrypt deployments (work factor `>=` 10), not to disqualifying bcrypt for new ones (read 2026-08-26) |
