...
| Library | Group | Architecture |
|---|---|---|
| **Pyodide** | tier 1 wasm based | CPython compiled to WebAssembly |
| **JupyterLite** | tier 1 wasm based | Serverless Jupyter notebooks (Pyodide-powered) |
| **PyScript** | tier 1 wasm based | HTML-first framework (Pyodide/MicroPython dual runtime) |
| **Brython** | tier 2 transpilers | Python-to-JavaScript transpiler (runtime) |
| **Skulpt** | tier 3 legacy | Python 2.x implementation in JavaScript |
...
- No universal 'best' solution - choice depends on use case requirements (notebooks vs tutorials vs widgets)
