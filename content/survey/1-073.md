...
| **statsmodels** | The academic and statistical standard: ARIMA/SARIMAX, exponential smoothing, proper diagnostics. Chosen when the forecast has to be defended, not just produced. | 0.14.6 · 2025-12-05 |
| **Darts** | The modern unified framework — classical and neural models behind one API, so model comparison stops being a rewrite. The most comprehensive option, and the newest. | 0.46.1 · 2026-07-20 |
