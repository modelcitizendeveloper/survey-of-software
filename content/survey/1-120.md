...
| Library | Paradigm | License |
|---|---|---|
| **SimPy** | Process-based DES | MIT |
| **Mesa** | Agent-based modeling | Apache-2.0 |
| **salabim** | Process-based DES with animation | MIT |
| **Ciw** | Queueing network simulation | MIT |
| **desmod** | Component-based DES | MIT |
