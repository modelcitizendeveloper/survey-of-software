...
description: "Turning graph structure into vectors: node2vec, PyTorch Geometric and peers — random-walk sampling versus graph neural networks."
keywords: ["node2vec", "deepwalk", "pytorch geometric", "dgl", "karateclub", "stellargraph", "gem", "scikit network"]
...
Turning graph structure into vectors: node2vec, PyTorch Geometric and peers — random-walk sampling versus graph neural networks.
...
|---|---|---|
| **node2vec** | Stable (2016 paper, implementation active) | 0.5.0 · 2024-08-02 |
| **deepwalk** | Historic (2014 paper, limited maintenance) | 1.0.3 · 2018-04-29 |
| **pytorch_geometric** | Very active (v2.6+, enterprise adoption) | 0.0.2 · 2026-04-02 |
| **dgl** | Active (AWS-backed, v2.1+) | 2.2.1 · 2024-05-13 |
| **karateclub** | Active maintenance (scikit-learn API) | 1.3.3 · 2022-10-22 |
| **stellargraph** | Deprecated (development ceased 2021) | 1.2.1 · 2020-06-30 |
| **gem** | Inactive (last update 2019) | — |
| **scikit_network** | Active (v0.31+) | 0.33.5 · 2025-11-19 |
...
- node2vec offers the most flexible random walk sampling (BFS-DFS interpolation via p/q parameters)
- PyTorch Geometric dominates modern graph neural network implementations (23.9k GitHub stars, 4.5M downloads/month)
- karateclub provides 40+ graph embedding algorithms in a unified scikit-learn-like API
- DeepWalk (2014) established random walks for graph embeddings but lacks active maintenance
- Stellargraph ceased development in 2021, PyTorch Geometric became the de facto standard
