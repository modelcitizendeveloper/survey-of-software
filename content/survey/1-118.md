...
| **Testing Library** | Component tests in React, Vue, Svelte, Angular and React Native | An addition to your runner choice, never a replacement for it — Testing Library is not a test runner and needs Jest, Vitest or Mocha underneath. Budget for both. It remains the de facto component standard: 68.2M weekly downloads for @testing-library/dom and 55.7M for @testing-library/react, verified 2026-08-25. Commit activity is quiet for a package this widely used (dom-testing-library last pushed 2025-11-12, react-testing-library 2026-04-02), which reads as a mature API rather than a stalled one, but is worth re-checking on your own schedule. MIT. |
