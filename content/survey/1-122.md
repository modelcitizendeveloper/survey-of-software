---
title: "1.122 Monte Carlo Simulation Libraries"
description: "Comprehensive analysis of 7 Monte Carlo simulation libraries for Python: NumPy (RNG foundation), scipy.stats (distributions + quasi-MC), SALib (sensitivity…"
keywords: ["SALib", "PyMC", "library", "confidence", "risk", "technical merit", "chaospy", "OpenTURNS", "repository", "maturity tier", "primary use", "viability", "NumPy", "scipy.stats", "uncertainties"]
...
|---|---|---|
| **NumPy (numpy.random)** | BSD-3-Clause | 2.5.3 · 2026-09-06 |
| **scipy.stats** | BSD-3-Clause | 0.0.1 · 2024-06-04 |
| **SALib** | MIT | 1.5.2 · 2025-10-12 |
| **uncertainties** | BSD-3-Clause | 3.2.3 · 2026-01-09 |
| **PyMC** | Apache-2.0 | 6.3.2 · 2026-09-08 |
| **chaospy** | MIT | 4.3.21 · 2025-08-29 |
| **OpenTURNS** | LGPL | 1.27.post1 · 2026-06-19 |
...
- **universal foundation** — 15+ year horizon, NumFOCUS backing, critical infrastructure
- **sensitivity analysis specialist** — 3-5 year horizon, academic volunteer project, NO institutional backing
- **bayesian inference only** — 7-10 year horizon, NumFOCUS backing, commercial support available
- **high risk library** — library: chaospy; confidence: S1/S2/S3: 7-8/10 technical, S4: 2/10 strategic; risk: Single-maintainer project, dormant since 2025-08-29; installs and runs on Python 3.14.7 with NumPy 2.5.2 (tested 2026-08-26); recommendation: Usable today; keep an abstraction layer and a migration path to OpenTURNS/scipy.stats (re-checked 2026-08-26); technical merit: Polynomial chaos expansion excellent, but strategic risk unacceptable
- **industrial uq** — 10+ year horizon, industrial consortium (EDF, Airbus, Phimeca), regulatory acceptance
...
1. **Ecosystem Consolidation, with limits**: SciPy absorbed quasi-Monte Carlo into `scipy.stats.qmc`, and some standalone packages did fold (sobol_seq's last release is 2020-05-14). But absorption did not finish the design-of-experiments packages: pyDOE was revived under new maintainers at github.com/pydoe/pydoe and shipped v1.5.0 on 2026-08-20.
...
**GitHub**: Forked three ways, and the forks have diverged sharply
**Which one you install matters** (all read 2026-08-26):
- **pyDOE** — v1.5.0, released 2026-08-20 from new maintainers at github.com/pydoe/pydoe. Active.
- **pyDOE3** — v1.6.2, released 2026-01-12. Also active.
- **pyDOE2** — v1.3.0, last released 2020-01-27. This is the abandoned one.
**Verdict**: Not deprecated, and the original is the live one. For plain Latin
Hypercube or Sobol sampling `scipy.stats.qmc` is in a dependency you already have
and is the simpler choice. Reach for pyDOE when you need the factorial and
response-surface designs SciPy does not cover — full/fractional factorial,
Box-Behnken, central composite. If you do, install `pyDOE` or `pyDOE3`; `pyDOE2`
has not shipped in six years.
...
- pyDOE: Design of experiments — revived, v1.5.0 (2026-08-20). Its forks diverged: pyDOE3 is active (v1.6.2, 2026-01-12), pyDOE2 is not (v1.3.0, 2020-01-27)
...
1. **Don't reach for a DOE package for plain sampling**: `scipy.stats.qmc` covers Latin Hypercube, Sobol and Halton and is already installed. (pyDOE itself is *not* deprecated — v1.5.0 shipped 2026-08-20 — and it remains the right call for factorial and response-surface designs. Avoid the `pyDOE2` fork specifically: last release 2020-01-27.)
...
**Analysis:**
- **OpenTURNS**: Widest copula coverage in this set — 20+ families (critical for dependencies). Not the only option: chaospy ships Clayton, Gumbel, Joe, Student and Nataf copulas; scipy.stats has none (verified 2026-08-26)
...
- **Why:** Broadest copula coverage — 20+ families against chaospy's five, and none in scipy.stats (verified 2026-08-26)
...
| Correlated parameters (copulas)         | OpenTURNS  | OpenTURNS       | Broadest copula set    |
...
This starts from patterns, not from libraries: understand the common patterns developers face, then identify which tools solve them best.
...
- sobol_seq retired → scipy.stats.qmc (SciPy 1.7.0). pyDOE was NOT absorbed: it moved to github.com/pydoe/pydoe and shipped v1.5.0 on 2026-08-20 (verified 2026-08-26)
...
- Python 3.14 compatibility held: chaospy 4.3.21 installs and runs under Python 3.14.7 with NumPy 2.5.2 (tested 2026-08-26). The exposure is dormancy — no commits since 2025-08-29 — not breakage.
...
### Ecosystem Adaptation
- **Python version support**: declares `>=3.9`; ships a pure-Python wheel and runs on Python 3.14.7 with NumPy 2.5.2 (tested 2026-08-26)
...
- 2027: Reader tries to reproduce — as of 2026-08-26 chaospy still installs on Python 3.14, so this leg has not played out
...
**Evidence**:
- **Quasi-random sampling** → scipy.stats.qmc (Sobol, LHS, Halton, added in 1.7.0). This absorbed sobol_seq, whose README now redirects to SciPy; it did **not** absorb pyDOE, which was revived and shipped v1.5.0 on 2026-08-20
...
**Risk**: dormancy rather than breakage — no commits since 2025-08-29, while 4.3.21 installs and runs on Python 3.14.7 with NumPy 2.5.2 (tested 2026-08-26)
