...
description: "Collision detection: FCL, Bullet Physics and NVIDIA PhysX — broad-phase and narrow-phase algorithms across desktop, mobile, web and console targets."
keywords: ["Desktop", "Mobile", "Web", "Consoles", "core", "specialized", "FCL", "Bullet Physics", "NVIDIA PhysX", "Box2D", "Rapier", "Matter.js", "p2.js", "box-intersect", "dyn4j", "python-fcl", "PyBullet", "accessed", "data collected"]
...
Collision detection: FCL, Bullet Physics and NVIDIA PhysX — broad-phase and narrow-phase algorithms across desktop, mobile, web and console targets.
...
| Library | Group | Language | Focus |
|---|---|---|---|
| **FCL (Flexible Collision Library)** | core | C++ | Collision detection with distance queries |
| **Bullet Physics** | core | C++ | Full physics engine with collision detection |
| **NVIDIA PhysX** | core | C++ | Enterprise-grade physics with GPU acceleration |
| **Box2D** | core | C (v3), C++ (v2) | 2D physics and collision detection |
| **Rapier** | core | Rust | Modern high-performance 2D/3D physics |
| **Matter.js** | core | JavaScript | Browser-based 2D physics |
| **p2.js** | core | JavaScript | 2D physics with multiple collision algorithms |
| **box-intersect** | core | JavaScript | Fast AABB intersection testing |
| **dyn4j** | core | Java | Pure Java 2D collision and physics |
| **python-fcl** | specialized | Python | Python bindings for FCL |
| **PyBullet** | specialized | Python | Python bindings for Bullet |


**What the research found**

- Box2D is the de facto standard for 2D physics (proven, excellent docs)
- PhysX leads in AAA 3D (GPU acceleration, industry backing)
- Rapier represents modern Rust alternative (competitive performance)
- Matter.js dominates browser creative coding (ease of use)
- FCL unique for robotics distance queries (no direct alternative)
...
|---|---|
| 2D game | Box2D |
| 3D game (AAA) | PhysX or Bullet |
| Browser game | Matter.js (ease) or Rapier WASM (performance) |
| Robotics path planning | FCL |
| Rust ecosystem | Rapier |
