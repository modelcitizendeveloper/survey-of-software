...
| Library | Best for |
|---|---|
| **Tabula** | Simple tables, quick extraction, lattice/stream both |
| **Camelot** | Lattice tables (visible borders), government tenders |
| **pdfplumber** | Complex financial tables, merged cells, precise control |
...
| **Foundation Models** | Novel formats, multimodal reasoning, research project |
