...
description: "Parsing government budget documents: CAFRs and budget PDFs — the finding is that no general-purpose library exists, and what the workarounds actually cost."
keywords: ["avoid if", "skill level", "Tabula", "Camelot", "pdfplumber", "cafr-parsing", "XBRL libraries", "Custom Hybrid", "Foundation Models"]
...
Parsing government budget documents: CAFRs and budget PDFs — the finding is that no general-purpose library exists, and what the workarounds actually cost.
...
|---|---|---|
| **Tabula** | Simple tables, quick extraction, lattice/stream both | 2.10.0 · 2024-10-17 |
| **Camelot** | Lattice tables (visible borders), government tenders | 2.0.0 · 2026-06-04 |
| **pdfplumber** | Complex financial tables, merged cells, precise control | 0.11.10 · 2026-06-15 |
| **cafr-parsing** | State CAFRs, willing to create templates, reusable formats | — |
| **XBRL libraries** | XBRL-formatted reports, standardized data | — |
| **Custom Hybrid** | Large scale, diverse formats, long-term investment | — |
| **Foundation Models** | Novel formats, multimodal reasoning, research project | 0.0.1 · 2025-06-17 |
