...
| Library | Per Test Speed | Startup Overhead |
|---|---|---|
| **sqlmock (Go)** | < 1ms | — |
| **factory_boy build()** | < 1ms | — |
| **DatabaseCleaner :transaction** | 1-5ms | DB startup |
| **factory_boy create()** | 5-50ms | None + DB |
| **pytest-postgresql** | 1-3s startup then < 5ms | 1-3s |
| **pgTAP** | 10-100ms | DB startup |
| **Testcontainers (warm)** | 5-15s startup then 1-50ms | 5-15s |
| **DatabaseCleaner :truncation** | 50-500ms | DB startup |
| **DBUnit** | 100ms-1s | DB startup |
