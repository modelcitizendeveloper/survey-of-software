...
**sqlmock (Go)**, **factory_boy build()**, **DatabaseCleaner :transaction**, **factory_boy create()**, **pytest-postgresql**, **pgTAP**, **Testcontainers (warm)**, **DatabaseCleaner :truncation**, **DBUnit**
