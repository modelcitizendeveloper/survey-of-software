...
**Everything used to create the 40+ research pieces in this survey.**
...
**Think:** Components you'd find in a hardware store, not custom buildings.

---

## Ready to Replicate?

**[Read the complete methodology with step-by-step guide →](/survey/methodology)**

The methodology page includes:
- Detailed explanation of each pass
- Independence protocols
- Copy-paste prompt templates for Claude Code
- Execution workflows
- Tips for successful replication

**Or:** Start small with S1 rapid discovery on a category you need. You'll get 70% of the value in 10 minutes, then decide if deeper analysis is worth it.
...
**GitHub:** All research is open source at [github.com/modelcitizendeveloper/survey-of-software](https://github.com/modelcitizendeveloper/survey-of-software)
