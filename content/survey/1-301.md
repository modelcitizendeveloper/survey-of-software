...
| **census** | python packages | actively maintained |
| **censusdis** | python packages | actively maintained |
| **sodapy** | python packages | actively maintained |
| **pygris** | python packages | actively maintained |
| **Socrata** | platforms | — |
| **CKAN** | platforms | — |
| **Tabula** | document parsing | MIT |
| **Camelot** | document parsing | MIT |
