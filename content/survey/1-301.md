...
description: "Government Data Access: APIs, libraries, and strategies for programmatic access to federal, state, and local government data"
keywords: ["government data", "open data", "census api", "data portals", "socrata", "tidycensus", "api wrappers", "data access", "public data", "civic tech"]
...
Government Data Access: APIs, libraries, and strategies for programmatic access to federal, state, and local government data
...
|---|---|---|---|
| **tidycensus** | r packages | actively maintained | — |
| **RSocrata** | r packages | actively maintained | — |
| **censusapi** | r packages | actively maintained | — |
| **census** | python packages | actively maintained | 0.8.27 · 2026-05-15 |
| **censusdis** | python packages | actively maintained | 1.4.2 · 2025-07-22 |
| **sodapy** | python packages | actively maintained | 2.2.0 · 2022-08-31 |
| **pygris** | python packages | actively maintained | 0.2.1 · 2025-12-27 |
| **Socrata** | platforms | — | — |
| **CKAN** | platforms | — | 2.12.0 · 2026-08-26 |
| **Tabula** | document parsing | MIT | 2.10.0 · 2024-10-17 |
| **Camelot** | document parsing | MIT | 2.0.0 · 2026-06-04 |
| **pdfplumber** | document parsing | — | 0.11.10 · 2026-06-15 |
