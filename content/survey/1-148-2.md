...
|---|---|---|
| **Stanford CoreNLP** | Comprehensive NLP pipeline (tokenization, POS, parsing) | Organizations with existing NLP infrastructure |
| **Jiayan (嘉言)** | Specialized Classical Chinese segmentation | Segmentation component in custom Classical Chinese pipeline |
...
- **Market is small but global (50K-200K students/researchers)** — Sustainable with niche focus, not venture-scale - best for grants/institutional services
