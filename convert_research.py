...
def main():
    ...
    research_dir = script_dir / "packages" / "research"
    output_dir = script_dir / "docs" / "survey"

    # Create output directory
    output_dir.mkdir(parents=True, exist_ok=True)

    # Find all research directories with completed work
    # (directories with 01-discovery or metadata.yaml)
    research_pieces = []
    ...
    print(f"\nFound {len(research_pieces)} research pieces with content")
